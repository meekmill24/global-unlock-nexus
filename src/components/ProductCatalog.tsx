    ...
    <section id="catalog" className="py-16 sm:py-24 bg-slate-50/50 dark:bg-slate-950/50">
      <div className="container mx-auto px-6">
        ...
        <Tabs defaultValue="all" onValueChange={setActiveTab} className="mb-12">
          <TabsList className="bg-slate-900 dark:bg-slate-900 border border-slate-800 p-1.5 h-auto flex-wrap rounded-xl justify-start sm:justify-center">
            <TabsTrigger value="all" className="rounded-lg px-4 sm:px-8 py-2.5 text-[10px] sm:text-xs font-bold uppercase tracking-widest text-slate-300 hover:text-white data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-md data-[state=active]:shadow-primary/30 flex-1 sm:flex-none transition-all">All Services</TabsTrigger>
            <TabsTrigger value="featured" className="rounded-lg px-4 sm:px-8 py-2.5 text-[10px] sm:text-xs font-bold uppercase tracking-widest text-slate-300 hover:text-white data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-md data-[state=active]:shadow-primary/30 flex-1 sm:flex-none transition-all">Featured</TabsTrigger>
            <TabsTrigger value="imei" className="rounded-lg px-4 sm:px-8 py-2.5 text-[10px] sm:text-xs font-bold uppercase tracking-widest text-slate-300 hover:text-white data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-md data-[state=active]:shadow-primary/30 flex-1 sm:flex-none transition-all">IMEI Unlock</TabsTrigger>
            <TabsTrigger value="tools" className="rounded-lg px-4 sm:px-8 py-2.5 text-[10px] sm:text-xs font-bold uppercase tracking-widest text-slate-300 hover:text-white data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-md data-[state=active]:shadow-primary/30 flex-1 sm:flex-none transition-all">Software</TabsTrigger>
            <TabsTrigger value="remote" className="rounded-lg px-4 sm:px-8 py-2.5 text-[10px] sm:text-xs font-bold uppercase tracking-widest text-slate-300 hover:text-white data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-md data-[state=active]:shadow-primary/30 flex-1 sm:flex-none transition-all">Remote</TabsTrigger>
          </TabsList>
        </Tabs>
